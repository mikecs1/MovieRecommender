...
# Load precomputed embeddings shape: [num_movies, dim]
embeddings = np.load("tmdb_embeddings.npy") 
...
if movie_title:
    ...
    # Use precomputed embeddings - shape (1, dim)
    movie_idx = df[df["title"] == movie_title].index[0]
    embedding = embeddings[movie_idx:movie_idx+1]  
